...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
     ...
     <link href="Styles/SiteApplicationForm.css" rel="Stylesheet" type="text/css" />
        ...
        <script type="text/javascript">
            ...
            //Function to re-enable invalid Jquery code after partial refresh**********
            //inside AJAX UpdatePanel
            function initAjax() {
            ...
            //call the function everytime AJAX request is complete (endRequest event)
            $().ready(function () {
                initAjax();
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <ContentTemplate>
                <asp:ListView ID="lvComment" runat="server">
                    <EmptyDataTemplate>
                        <asp:Label ID="lblCommentDoesntExist" runat="server" Text="No comment exists for this application."></asp:Label>
                    </EmptyDataTemplate>
                    <ItemTemplate>
                ...
                <br /><br />
                <div class="dpComment">
                <asp:DataPager ID="dpComment" runat="server" PagedControlID="lvComment" PageSize="5" 
                               OnPreRender="dpComment_PreRender" >
                    <Fields>
                        <asp:NextPreviousPagerField ShowFirstPageButton="True" ShowNextPageButton="false" />
                        <asp:NumericPagerField CurrentPageLabelCssClass="dpNumeric"/>
